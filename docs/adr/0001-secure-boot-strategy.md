...
- Needs a signing key generated and stored (mirroring how `PROXMOX_SSH_KEY` is already handled as a CI secret) and a build step that fetches/vendors the shim and signs GRUB/kernel/initrd for both images.
